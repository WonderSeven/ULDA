...
from engine import fsl_baseline as bl
...
class Trainer(object):
    def __init__(self, cfg):
        ...
        self.opt = inits.get_solver(cfg, self.emb_net, self.cla_net)
    ...
    def _train_net(self, epoch):
        ...
        loss, top1, top3 = bl.train(opt, epoch, self.emb_net, self.cla_net, self.train_loader, self.opt, self.loss_func, self.use_cuda, self.print_freq)
