...
@Embeddings.register('resnet34')
def resnet24(keep_prob=1.0, avg_pool=False, **kwargs):
    """Constructs a ResNet-24 model.
    """
    model = ResNet(BasicBlock, [2, 3, 3, 3], keep_prob=keep_prob, avg_pool=avg_pool, **kwargs)
    return model
...
if __name__ == '__main__':
    ...
    model = model_dict[args.model](avg_pool=False, drop_rate=0.1, dropblock_size=5)
