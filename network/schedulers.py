...
__all__ = ['PolyLR', 'StepLR', 'CosineLR', 'NoneLR']
...
@configs.Schedulers.register('poly')
...
@configs.Schedulers.register('step')
...
@configs.Schedulers.register('cos')
...
@configs.Schedulers.register('none')
